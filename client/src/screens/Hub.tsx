...
import type { AnswerMode, BotDifficulty, User } from '../lib/types';
...
function ModeCard({
  ...
  return (
    <Glass className={`mode ${className}`} radius={30} bezel={24} tone={accent ? 'panel' : 'deep'} blur={2}>
  ...
  return (
    <main className="page hub">
      ...
      <div className="hub__grid">
        <ModeCard title="Ranked" icon={<Swords size={20} />} className="mode--ranked" accent>
          <p className="mode__desc">
            1 gegen 1 um Punkte. Alle spielen dieselben Fragen aus dem Allgemein-Paket, Auswahl und Tippen gemischt, neun Fragen.
          </p>
        ...
        <ModeCard title="Unranked" icon={<Zap size={20} />}>
          <p className="mode__desc">1 gegen 1 mit deinen Paketen. Gespielt wird, was ihr beide ausgewählt habt.</p>
          <Button
            block
            disabled={tooFew}
        ...
        <ModeCard title="Private Lobby" icon={<Users size={20} />}>
          <p className="mode__desc">Bis zu acht Leute per Code, Bots erlaubt. Du bestimmst Pakete, Modus und Länge.</p>
        ...
        <ModeCard title="Training" icon={<Dumbbell size={20} />}>
          ...
          <div className="mode__sub">
            ...
            {prefs.trainingMode === 'survival' && <p className="mode__desc">Drei Leben. Jede falsche oder verpasste Antwort kostet eins.</p>}
        ...
        <Glass className="setup" radius={30} bezel={24} tone="deep" blur={2}>
          ...
          <div className="setup__block">
            ...
            <p className="setup__explain">
              {prefs.answerMode === 'choice' && 'Drei Antworten zur Wahl, ein Versuch pro Frage.'}
              {prefs.answerMode === 'typed' && 'Du tippst die Antwort selbst. Kleine Tippfehler zählen trotzdem.'}
              {prefs.answerMode === 'mixed' && 'Mal Auswahl, mal Tippen, von Frage zu Frage neu.'}
            </p>
          </div>
          <div className="setup__block">
            ...
            {summary.parts.length ? (
              ...
              <p className="setup__empty">Noch kein Paket gewählt. Ohne Fragen kein Spiel.</p>
            )}
            <Button size="sm" block onClick={() => navigate('pakete')}>
              Pakete wählen
            </Button>
          </div>
        </Glass>
